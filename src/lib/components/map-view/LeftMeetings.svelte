<script lang="ts">
	...
	$: visibleUpcoming = showAllUpcoming ? filteredUpcoming : filteredUpcoming.slice(0, UPCOMING_MIN);
...
<aside
	bind:this={sidebarEl}
	class="flex h-full min-h-0 flex-col gap-4 overflow-hidden px-4 self-stretch"
>
	...
	<!-- QuickCommand is not done and ready for use. It has been commented out for now. -- Pierre
	2026/08/26 -->
	<!-- <QuickCommands /> -->
</aside>
